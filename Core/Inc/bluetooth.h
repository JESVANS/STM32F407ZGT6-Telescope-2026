...
/* 缓冲区大小 */
#define BT_RX_BUF_SIZE         256U            /* 环形接收缓冲区字节数 */
#define BT_TX_BUF_SIZE         256U            /* printf 格式化发送缓冲区 */
...
/* 中断发送原始数据（非阻塞，发送完成后触发 HAL_UART_TxCpltCallback） */
